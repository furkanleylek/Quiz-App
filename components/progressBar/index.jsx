...
function ProgressBar() {
    ...
    return (
        <div className='border-2 border-slate-700 rounded w-[calc(100%+80px)] h-4 flex mb-8'>
            <span className={progress >= 1 && `bg-${progressColor[0]}-500 h-full w-[10%] border-r-2 border-slate-900`}></span>
            ...
            <span className={progress >= 10 && `bg-${progressColor[9]}-500 h-full w-[10%]`}></span>
        </div>
    )
}
